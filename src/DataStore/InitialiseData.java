...
public class InitialiseData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            thursday.addToInnerArray(1, 0, "Room 4");
            ...
            thursday.addToInnerArray(1, 1, "Room 4");
            ...
            thursday.addToInnerArray(1, 2, "Room 4");
            ...
            thursday.addToInnerArray(1, 3, "Room 4");
            thursday.addToInnerArray(2, 3, "Nicholas Rosario (MasterChen)");
            thursday.addToInnerArray(3, 3, "'Weaponize Your Feature Codes'");

            thursday.addToInnerArray(0, 3, "14:00");
            thursday.addToInnerArray(1, 3, "Room 4");
            thursday.addToInnerArray(2, 3, "Zero_Chaos & Granolocks");
            thursday.addToInnerArray(3, 3, "'Realtime bluetooth device detection with Blue Hydra'");

            thursday.addToInnerArray(0, 3, "15:00");
            thursday.addToInnerArray(1, 3, "Room 4");
            thursday.addToInnerArray(2, 3, "LosT");
            thursday.addToInnerArray(3, 3, "'Hacker Fundamentals and Cutting Through Abstraction'");

            thursday.addToInnerArray(0, 3, "16:00");
            thursday.addToInnerArray(1, 3, "Room 4");
            thursday.addToInnerArray(2, 3, "DC101");
            thursday.addToInnerArray(3, 3, "'DEF CON 101 Panel'");
            ...
            friday.addToInnerArray(0, "10:00");
            friday.addToInnerArray(1, 2, "Room 4");
            friday.addToInnerArray(2, 2, "Joe Grand (King-pin) & Zoz");
            friday.addToInnerArray(3, 2, "'BSODomizer HD: A mischevious FPGA and HDMI platform for the (m)asses'");


            friday.addToInnerArray(0, "11:00");
            friday.addToInnerArray(1, 2, "Room 1");
            friday.addToInnerArray(2, 2, "Ladar Levison");
            friday.addToInnerArray(3, 2, "'Compelled Decryption - State of the Art in Doctrinal Perversions'");

            friday.addToInnerArray(0, "11:00");
            friday.addToInnerArray(1, 2, "Room 2");
            friday.addToInnerArray(2, 2, "Mudge Zatko & Sarah Zatko");
            friday.addToInnerArray(3, 2, "'Project CITL'");
